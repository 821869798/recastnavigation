...
{
	public static class ExportScene2ObjTools
	{

		[MenuItem("GameEditor/RecastNavigation/ExportScene/ExportSceneToObj-NavStatic")]
		//[MenuItem("GameObject/ExportScene/ExportSceneToObj")]
		public static void ExportNavStatic()
		{
			ExportSceneToObjNavStaicSelectFile(false);
		}

		[MenuItem("GameEditor/RecastNavigation/ExportScene/ExportSceneToObj-NavStatic(AutoCut)")]
		//[MenuItem("GameObject/ExportScene/ExportSceneToObj(AutoCut)")]
		public static void ExportNavStaticAutoCut()
		{
			ExportSceneToObjNavStaicSelectFile(true);
		}

		[MenuItem("GameEditor/RecastNavigation/ExportScene/ExportSceneToObj")]
		//[MenuItem("GameObject/ExportScene/ExportSceneToObj")]
		public static void Export()
		{
			ExportSceneToObjSelectFile(false);
		}

		[MenuItem("GameEditor/RecastNavigation/ExportScene/ExportSceneToObj(AutoCut)")]
		//[MenuItem("GameObject/ExportScene/ExportSceneToObj(AutoCut)")]
		public static void ExportAutoCut()
		{
			ExportSceneToObjSelectFile(true);
		}

		[MenuItem("GameEditor/RecastNavigation/ExportScene/ExportSelectedObj")]
		...
		public static void ExportSceneToObjNavStaicSelectFile(bool autoCut)
		{
			string path = GetSavePath(autoCut, null);
			if (string.IsNullOrEmpty(path)) return;
			ExportSceneToObjNavStaic(path, autoCut);
		}

		public static void ExportSceneToObjNavStaic(string path, bool autoCut)
		{
		...
		public static void ExportSceneToObjSelectFile(bool autoCut)
		{
			string path = GetSavePath(autoCut, null);
			if (string.IsNullOrEmpty(path)) return;
			ExportSceneToObj(path, autoCut);
		}

		public static void ExportSceneToObj(string path, bool autoCut)
		{
			Terrain terrain = UnityEngine.Object.FindObjectOfType<Terrain>();
