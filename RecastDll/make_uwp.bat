...
cmake -G "Visual Studio 17 2022" -A ARM64 -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
cmake --build build_uwp_arm64 --config Release
md Plugins\WSA\ARM64
copy /Y build_uwp_arm64\Release\RecastDll.dll Plugins\WSA\ARM64\RecastDll.dll
